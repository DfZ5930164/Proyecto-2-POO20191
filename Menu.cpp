...
enum class Opciones { Agregar=1, Remover, Mostrar,Ubicar,Mas_cercanos,Por_tipo,Mejor_calificacion};
...
void Menu::imprimirMenu() {
    ...
    cout << "3. Dibujar Mapa\n\n";
    cout << "4. Ubicar Puntos mas cercanos\n\n";
    cout << "5. Ubicar por tipo\n";
    cout << "6. Ubicar por mejor calificacion\n\n";
    cout << "0. Para Salir\n\n";
}
...
void Menu::seleccionarOpcion() {
    ...
    switch(Opciones(opcion)) {
        ...
        case Opciones::Mostrar: // Dibujando Tierra
            dibujarMapa();
            break;
        case Opciones::Mas_cercanos:  // Agregar Objeto
            ubicarmascercanos();
            break;
        case Opciones::Por_tipo:  // Remover Objeto
            ubicarportiopo();
            break;
        case  Opciones::Mejor_calificacion: // Dibujando Tierra
            ubicarmejorcalificacion();
            break;

    }
}

void Menu::ubicarportiopo() {

}
void Menu::ubicarmejorcalificacion() {

}
void Menu::ubicarmascercanos() {
